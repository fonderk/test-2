...
Город: '.$_POST['city'].'<br />
Услуга: '.$_POST['taskOption'].'<br />
Комментарий: '.$_POST['comment'].'<br />
IP:  '.$_SERVER['REMOTE_ADDR'].'<br />
Utm_source: '.$_COOKIE['utm_source'].'<br />
Utm_medium: '.$_COOKIE['utm_medium'].'<br />
Utm_campaign: '.$_COOKIE['utm_campaign'].'<br />
Utm_content: '.$_COOKIE['utm_content'].'<br />
